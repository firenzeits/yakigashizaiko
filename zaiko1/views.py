...
def index(request):
    ...
    return render(request, 'zaiko1/index.html', params)
...
#        innerdata.append(zaiko[2])          
    ...
    return render(request, 'zaiko1/update.html', params)
...
def shipping(request):
    ...
    if (request.method =='POST'):
        ...
        if ( int(fromnum) < int(shippingnum) ):
            ...
            return render(request, 'zaiko1/shipping.html', params)
        else:
            msg="以下の通り在庫を移動させます。"
...
def shippinghistory(request):
    ...
    return render(request, 'zaiko1/shippinghistory.html', params)
